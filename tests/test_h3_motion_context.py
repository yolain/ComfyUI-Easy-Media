...
def test_drift_control_reports_original_and_current_latent_resolution():
    ...
    assert "original context HxW=2x3" in str(error.value)
    assert "current target HxW=4x5" in str(error.value)
