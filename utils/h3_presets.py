...
DEFAULT_H3_PRESETS: dict[str, dict[str, dict[str, dict[str, Any]]]] = {
    "ultra_light": {
        "single": {
            "is_turbo": {
                "sampler": "euler",
                "sigmas": "1.0000, 0.9730, 0.9231, 0.8000, 0.0000"
            },
            "non_turbo": {
                "sampler": "euler",
                "sigmas": "1.0000, 0.9730, 0.9231, 0.8000, 0.6792, 0.4877, 0.2857, 0.0837, 0.0000"
            }
        },
        "dual": {
            "is_turbo": {
    ...
    "light": {
        "single": {
            "is_turbo": {
                "sampler": "euler",
                "sigmas": "1.0000, 0.9730, 0.9231, 0.8000, 0.4737, 0.1579, 0.0000"
            },
            "non_turbo": {
                "sampler": "euler",
                "sigmas": "1.0000, 0.9901, 0.9778, 0.9620, 0.9412, 0.9123, 0.8696, 0.8000, 0.6792, 0.4877, 0.2857, 0.0837, 0.0000"
            }
        },
        "dual": {
            "is_turbo": {
    ...
    "medium": {
        "single": {
            ...
            "non_turbo": {
                "sampler": "er_sde",
                "sigmas": "1.0000, 0.9956, 0.9908, 0.9855, 0.9796, 0.9730, 0.9655, 0.9571, 0.9474, 0.9362, 0.9231, 0.9076, 0.8889, 0.8660, 0.8372, 0.8000, 0.7500, 0.6792, 0.4877, 0.2857, 0.0837, 0.0000"
            }
        },
        "dual": {
            "is_turbo": {
    ...
    "high": {
        "single": {
            ...
            "non_turbo": {
                ...
                "sigmas": "1.0000, 0.9970, 0.9938, 0.9904, 0.9867, 0.9826, 0.9781, 0.9730, 0.9674, 0.9611, 0.9541, 0.9462, 0.9373, 0.9272, 0.9157, 0.9025, 0.8873, 0.8696, 0.8485, 0.8222, 0.7887, 0.6792, 0.4877, 0.2857, 0.0837, 0.0000"
            }
        },
        "dual": {
            "is_turbo": {
